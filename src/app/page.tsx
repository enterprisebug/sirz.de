...
import logoAirbnb from '@/images/logos/work.svg'
import logoFacebook from '@/images/logos/work.svg'
import logoCat from '@/images/logos/work.svg'
import logoStarbucks from '@/images/logos/work.svg'
import image1 from '@/images/photos/Daniel Sirz Superhero.jpeg'
import image2 from '@/images/photos/image-2.jpg'
import image3 from '@/images/photos/image-3.jpg'
import image4 from '@/images/photos/Daniel Sirz Barista.png'
import image5 from '@/images/photos/Daniel Sirz Business.png'
...
function Resume() {
  let resume: Array<Role> = [
    ...
    {
      company: 'syscovery netsoft GmbH',
      title: 'Consultant',
      logo: logoFacebook,
      start: '04/2008',
      end: '08/2012',
      ...
      <Container className="mt-9">
        <div className="max-w-3xl">
          ...
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            ...
            I enjoy seeing my kids growing up and a large cup of coffee 🍵 in
            the morning! Keen on playing Tennis and Beach-Volleyball.
          </p>
